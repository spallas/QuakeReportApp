...
public final class QueryUtils {
     ...
     */
    public static ArrayList<Earthquake> extractEarthquakes(String url_string) {
        ...
        try {
            ...
            // Parses the response given by the JSON_RESPONSE string and
            ...
            for (int i = 0; i < array.length(); i++) {
                JSONObject at_i = array.getJSONObject(i);
                JSONObject properties = at_i.getJSONObject("properties");
                double mag = properties.getDouble("mag");
                String location = properties.getString("place");
                long date = properties.getLong("time");
                String web_url = properties.getString("url");
                earthquakes.add(new Earthquake(location, date, mag, web_url));
            }
